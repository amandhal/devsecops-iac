...
public class App {
    ...
    // 1) Hardcoded secret (Security Hotspot)
        private static final String API_KEY = "AMAN_PROJECT_SECRET";

            public static void main(String[] args) throws Exception {

                    // 2) Using System.out instead of logger (Maintainability)
                            System.out.println("Starting Aman DevSecOps Project...");
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    OutputStream os = exchange.getResponseBody();
                                                                                                                                                                                                                                                                                                                os.write(out);
                                                                                                                                                                                                                                                                                                                            os.close();
                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                            System.out.println("Aman app running on port " + port);
                                                                                                                                                                                                                                                                                                                                                    server.start();
                                                                                                                                                                                                                                                                                                                                                        }

                                                                                                                                                                                                                                                                                                                                                            // simple helper method for tests
                                                                                                                                                                                                                                                                                                                                                                public static String brandHtml() {
                                                                                                                                                                                                                                                                                                                                                                        return "<h1>Amanz DecSecOps Project</h1><p>Simple Application deployed using CICD approach</p>";
                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                            }